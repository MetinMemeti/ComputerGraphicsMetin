...
import { AmbientLight, PointLightHelper } from 'three/webgpu';
...
const pointLight = new THREE.PointLight(0xff9000, 1.5 ,0, 0.2)
...
const reactAreaLight = new THREE.RectAreaLight(0x4e00ff, 6, 6 ,1)
scene.add(reactAreaLight)

const rectAreaLightHelper = new RectAreaLightHelper(reactAreaLight, 0.4)
